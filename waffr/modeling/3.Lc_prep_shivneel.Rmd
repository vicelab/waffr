...
ca_boundary.path <- "C:/Users/dsx/Box/VICE Lab/RESEARCH/PROJECTS/wfar/input/SHAPEFILES/cnty24k09/cnty24k09_state_poly_s100.shp"
lc.dir <- "C:/Users/dsx/Box/VICE Lab/RESEARCH/PROJECTS/wfar/input/CDL_CA_WGS84"
...
resample_cdl <- function(lc.table, abs_path, source, product_name) {
  dir.create(paste0("C:/Users/dsx/Downloads/output/cleaned_inputs/", source, "_30m/"), recursive = TRUE, showWarnings = FALSE)
  outpath <- paste0("C:/Users/dsx/Downloads/output/cleaned_inputs/", source, "_30m/", product_name, ".tif")
...
filtered_df <- lc.table[lc.table["anoml"] == TRUE,]
resample_cdl(lc.table, filtered_df["abs_path"][[1]][1], filtered_df["source"][[1]][1], filtered_df["product_name"][[1]][1])
```
